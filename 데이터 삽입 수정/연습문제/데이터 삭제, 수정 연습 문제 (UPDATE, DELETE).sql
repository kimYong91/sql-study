...
UPDATE Books SET Genre = 'Technical' WHERE TITLE = 'Learning SQL';
...
SELECT * FROM Members WHERE Email = 'lucy.h@example.com';
...
SELECT * FROM BorrowRecords WHERE ReturnDate = '2023-04-30';